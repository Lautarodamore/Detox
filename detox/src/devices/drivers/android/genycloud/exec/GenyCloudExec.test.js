describe('Genymotion-cloud executable', () => {
  ...
  [
    ...
    },
    {
      ...
      commandExecFn: () => uut.startInstance(recipeName, uniqueNameSeed),
      expectedExec: `"gmsaas" --format compactjson instances start --stop-when-inactive ${recipeName} "detox-${uniqueNameSeed}"`,
    },
    {
